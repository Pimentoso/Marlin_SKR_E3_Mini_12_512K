...
#define CUSTOM_MACHINE_NAME "CRIME MACHINE"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Creality Ender-3
  #define DEFAULT_Kp 30.6
  #define DEFAULT_Ki 3.2
  #define DEFAULT_Kd 73.0
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
// #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 95 } for normal extruder
