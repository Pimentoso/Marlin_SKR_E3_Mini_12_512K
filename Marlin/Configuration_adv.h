...
#define LIN_ADVANCE
  ...
  #define LIN_ADVANCE_K 0.1    // Unit: mm compression per 1mm/s extruder speed, set with http://marlinfw.org/tools/lin_advance/k-factor.html for my titan aero config
